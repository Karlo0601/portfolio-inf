 ...
 *
 * @since   1.0.0
 * @package Portfolio_Inf\Admin\Menu
 */

namespace Portfolio_Inf\Admin\Menu;
...
class Menu {
  ...
  public function get_menu_positions() {
    return array(
        'header_main_nav' => esc_html__( 'Main Menu', 'portfolio-inf' ),
        'footer_main_nav' => esc_html__( 'Footer Menu', 'portfolio-inf' ),
    );
  }
